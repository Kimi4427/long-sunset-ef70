...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/long-sunset-ef70#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/long-sunset-ef70
```

A live public deployment of this template is available at [https://long-sunset-ef70.templates.workers.dev](https://long-sunset-ef70.templates.workers.dev)
